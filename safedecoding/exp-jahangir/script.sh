...
# test BLOOM models
# CUDA_VISIBLE_DEVICES=2 python test_bloom.py --model_name bloom


# waiting for approval from Llama 3 repository, check back later
# test Tiger LLM models
# CUDA_VISIBLE_DEVICES=2 python test_tigerllm.py --model_name tiger
