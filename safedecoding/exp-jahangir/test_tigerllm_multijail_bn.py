# Test TigerLLM with MultiJail Bengali prompts
# =============================================
...
class TigerLLMTester:
    ...
    def generate_text(self, prompt: str, max_new_tokens = 512,
...
# Cell 5: Run MultiJail Bengali Tests
# ==================================
print("\n" + "="*60)
print("🎯 TESTING MULTIJAIL BENGALI PROMPTS")
print("="*60)

# Run tests with all prompts
multijail_results = tester.batch_test(prompts, "MultiJail_Bengali", max_new_tokens=512, temperature=0.95)

# Analyze results
print("\n📊 MultiJail Bengali Analysis:")
quality_scores = tester.evaluate_quality(multijail_results, ['fluency', 'coherence', 'relevance', 'length_consistency'])
...
print("="*60)
tester.save_results_to_json("tigerllm_multijail_bn_results.json")

# Save evaluation results with scores
print("\n" + "="*60)
print("📊 SAVING EVALUATION RESULTS WITH SCORES")
print("="*60)
tester.save_evaluation_results_to_json("tigerllm_multijail_bn_evaluation_results.json")
